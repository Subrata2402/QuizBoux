...
class MainClass(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name = f"{ctx.prefix}start [mimir/display/hq]", value = "Start Websocket of Mimir/Display.", inline = False)
        embed.add_field(name = f"{ctx.prefix}close [mimir/display/hq]", value = "Close Websocket of Mimir/Display.", inline = False)
