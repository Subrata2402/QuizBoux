...
class MainClass(commands.Cog, Websocket):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name = f"{ctx.prefix}login [username] [password]", value = "Login to Display for start websocket. Before login please read the display notes.", inline = False)
