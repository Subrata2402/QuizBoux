...
client = commands.Bot(command_prefix = ">", description="This is a trivia bot for discord server.")
client.add_cog(Quizophy(client))


client.run("ODU4MzcxMDk2MjIyNzYxMDAw.G7iOn5.3cIXRr9zhtl2KemUSlqoInXVFO03JA4-lrssgU")